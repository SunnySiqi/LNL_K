...
class FCoteachingTrainer(BaseTrainer):
    ...
    def update_dataloader(self, epoch):
        ...
        with torch.no_grad():
            ...
            self.vector_dict, self.teacher_idx_1 = fine(self.vector_dict, current_features_2, current_labels_2, fit='gmm', prev_features=prev_features_2, prev_labels=prev_labels_2)
            self.vector_dict, self.teacher_idx_2 = fine(self.vector_dict, current_features_1, current_labels_1, fit='gmm', prev_features=prev_features_1, prev_labels=prev_labels_1)
